...
def main():
    ...
    # Using Streamlit's st.image with a container div
    st.markdown('<div class="full-width">', unsafe_allow_html=True)
    st.image("images/hh.png", use_column_width='always')
    st.markdown('</div>', unsafe_allow_html=True)

    st.markdown('<h1 class="small-title">Heart Disease Prediction</h1>', unsafe_allow_html=True)
